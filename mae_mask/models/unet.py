...
class UNet(nn.Module):
    def __init__(self, mae_model):
        ...
        self.fc = nn.Linear(117, 196)

        self.dconv_up4 = double_conv(1024, 512)
        self.dconv_up3 = double_conv(512, 320)
    ...
    def forward(self, imgs, mask_ratio=0.4):
        ...
        encoder_outputs = encoder_outputs.reshape(-1, 1024, 117)  
        encoder_outputs = self.fc(encoder_outputs) # (16,400,196)
        encoder_outputs = encoder_outputs.reshape(-1, 1024, 14, 14)
